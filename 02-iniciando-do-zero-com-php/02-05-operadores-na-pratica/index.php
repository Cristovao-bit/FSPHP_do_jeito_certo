...
$incrementB = 5;
$increment = [
    "pós-incremente" => $incrementA++,
    "res-incremente" => $incrementA,
    "pré-incremente" => ++$incrementA,
...
$relatedC = 10;
$related = [
    "a == b" => ($relatedA == $relatedB), // se o valor são iguais
    "a === b" => ($relatedA === $relatedB), // se o valor e o tipo são iguais
    "a != b" => ($relatedA != $relatedB), // se a é diferente no valor de b
    "a !== b" => ($relatedA !== $relatedB), // se a é diferente no valor e no tipo de b
...
$logicB = false;
$logic  = [
    "a && b" => ($logicA && $logicB), // existe a e b
    "a || b" => ($logicA || $logicB), // existe um ou outro
    "a" => ($logicA), // existe a
    "! a" => (!$logicA), // não existe a
    "! b" => (!$logicB) // não existe b
];
