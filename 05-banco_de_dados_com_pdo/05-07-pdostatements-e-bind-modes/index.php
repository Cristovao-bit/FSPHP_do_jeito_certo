...
$stmt = Connect::getInstance()->prepare("INSERT INTO users (first_name, last_name) VALUES (?, ?)");
...
$stmt = Connect::getInstance()->prepare("INSERT INTO users (first_name, last_name) VALUES (:first_name, :last_name)");
