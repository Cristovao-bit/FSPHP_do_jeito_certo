...
var_dump([
    "string" => $string,
    "strlen" => strlen($string), // contagem de caracteres total com acentos contado com um caractere também.
    "mb_strlen" => mb_strlen($string), // contagem de caractere sem os acentos com caractere.
...
var_dump([
    "mb_strlen" => mb_strlen($mbReplace), // contagem de caractere
    "mb_strpos" => mb_strpos($mbReplace, ", "), // primeira vírgula
    "mb_strrpos" => mb_strrpos($mbReplace, ", "), // segunda vírgula
    "mb_substr" => mb_substr($mbReplace, 40 + 2, 14),
    "mb_strstr" => mb_strstr($mbReplace, ", ", true),
    "mb_strrchr" => mb_strrchr($mbReplace, ", ", true)// true inverte a ocorrência
]);

$mbStrReplace = $string;

echo "<p>", $mbStrReplace ,"</p>";
echo "<p>" , str_replace("AC/DC", "Nirvana", $mbStrReplace) , "</p>";// o que; pelo que; e onde
echo "<p>" , str_replace(["AC/DC", "eu fui", "último" ], "Nirvana", $mbStrReplace), "</p>";
echo "<p>" , str_replace(["AC/DC", "incrível"], ["Nirvana", "Épicooooooooooooooo!"], $mbStrReplace) , "</p>";
...
$endPoint = "name=cristovaolbraga&email=suporte@manutencaolira.com";
