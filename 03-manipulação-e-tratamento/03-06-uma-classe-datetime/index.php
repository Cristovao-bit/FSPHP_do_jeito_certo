...
$dateBirth = new DateTime('1992-05-27');
$dateStatic = DateTime::createFromFormat("d/m/Y", "28/11/2020");
...
$birth = new DateTime("2021-05-27");
$dateNows = new DateTime("now");

$diff = $dateNows->diff($birth);
